...
class Policy(nn.Module):
    ...
    def act(
        ...
        distribution, _ = self.action_distribution(features)
...
class PointNavBaselineNet(Net):
    ...
    def __init__(self, observation_space, hidden_size, goal_sensor_uuid):
        ...
        self.img_encoder = SimpleCNN(observation_space, hidden_size)
    ...
    def forward(self, observations, rnn_hidden_states, prev_actions, masks):
        ...
        if not self.is_blind:
            perception_embed = self.img_encoder(observations)
