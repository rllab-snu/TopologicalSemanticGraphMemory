    ...
    def update(self, rollouts):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                if 'progress' in obs_batch: #progress monitor
        ...
        progress_loss_epoch /= num_updates
        goal_loss_epoch /= num_updates

        return value_loss_epoch, action_loss_epoch, dist_entropy_epoch, [progress_loss_epoch, goal_loss_epoch]
